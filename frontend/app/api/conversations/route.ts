...
import { getConversations, testConnection } from '@/lib/neo4j';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const { page, limit } = validateApiPaginationParams(request, 'conversations-api');

    // Use the optimized getConversations function with validated parameters
